...
use Modules\Agent\Facades\AgentFacade;
...
class AgentController extends Controller
{
    ...
    {
        $data = AgentFacade::store($request->validated());
    ...
    {
        $data = AgentFacade::update($request->validated(), $id);
    ...
    {
        return $this->deletedResponse(AgentFacade::delete($id), 'Agent');
    }
}
