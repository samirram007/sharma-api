...
class AppModuleFeatureTest extends TestCase
{
    ...
    public function test_can_create_app_module_feature(): void
    {
    ...
    public function test_can_show_app_module_feature(): void
    {
    ...
    public function test_can_update_app_module_feature(): void
    {
        $AppModuleFeature = AppModuleFeature::factory()->create();
    ...
    public function test_can_delete_app_module_feature(): void
    {
        $AppModuleFeature = AppModuleFeature::factory()->create();
