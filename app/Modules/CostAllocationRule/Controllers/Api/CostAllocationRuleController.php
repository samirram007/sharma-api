...
use Modules\CostAllocationRule\Facades\CostAllocationRuleFacade;
...
class CostAllocationRuleController extends Controller
{
    ...
    {
        $data = CostAllocationRuleFacade::getAll();
    ...
    {
        $data = CostAllocationRuleFacade::getById($id);
    ...
    {
        $data = CostAllocationRuleFacade::store($request->validated());
    ...
    {
        $data = CostAllocationRuleFacade::update($request->validated(), $id);
    ...
    {
        return $this->deletedResponse(CostAllocationRuleFacade::delete($id), 'CostAllocationRule');
    }
}
