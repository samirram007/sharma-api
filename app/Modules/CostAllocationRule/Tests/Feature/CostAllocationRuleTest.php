...
class CostAllocationRuleTest extends TestCase
{
    ...
    public function test_can_create_cost_allocation_rule(): void
    {
    ...
    public function test_can_show_cost_allocation_rule(): void
    {
    ...
    public function test_can_update_cost_allocation_rule(): void
    {
        $CostAllocationRule = CostAllocationRule::factory()->create();
    ...
    public function test_can_delete_cost_allocation_rule(): void
    {
        $CostAllocationRule = CostAllocationRule::factory()->create();
