...
namespace Modules\CostCategory\Tests\Feature;
...
class CostCategoryTest extends TestCase
{
    ...
    public function test_can_create_cost_category(): void
    {
    ...
    public function test_can_show_cost_category(): void
    {
    ...
    public function test_can_update_cost_category(): void
    {
        $CostCategory = CostCategory::factory()->create();
    ...
    public function test_can_delete_cost_category(): void
    {
        $CostCategory = CostCategory::factory()->create();
