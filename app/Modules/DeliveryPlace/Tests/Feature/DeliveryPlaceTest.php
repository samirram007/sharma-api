...
class DeliveryPlaceTest extends TestCase
{
    ...
    public function test_can_create_delivery_place(): void
    {
    ...
    public function test_can_show_delivery_place(): void
    {
    ...
    public function test_can_update_delivery_place(): void
    {
        $DeliveryPlace = DeliveryPlace::factory()->create();
    ...
    public function test_can_delete_delivery_place(): void
    {
        $DeliveryPlace = DeliveryPlace::factory()->create();
