...
namespace Modules\DeliveryVehicle\Tests\Feature;
...
class DeliveryVehicleTest extends TestCase
{
    ...
    public function test_can_create_delivery_vehicle(): void
    {
    ...
    public function test_can_show_delivery_vehicle(): void
    {
    ...
    public function test_can_update_delivery_vehicle(): void
    {
        $DeliveryVehicle = DeliveryVehicle::factory()->create();
    ...
    public function test_can_delete_delivery_vehicle(): void
    {
        $DeliveryVehicle = DeliveryVehicle::factory()->create();
