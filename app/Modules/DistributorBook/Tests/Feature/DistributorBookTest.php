...
namespace Modules\DistributorBook\Tests\Feature;
...
class DistributorBookTest extends TestCase
{
    ...
    public function test_can_create_distributor_book(): void
    {
    ...
    public function test_can_show_distributor_book(): void
    {
    ...
    public function test_can_update_distributor_book(): void
    {
        $DistributorBook = DistributorBook::factory()->create();
    ...
    public function test_can_delete_distributor_book(): void
    {
        $DistributorBook = DistributorBook::factory()->create();
