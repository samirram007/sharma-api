...
use Modules\EmployeeGroup\Facades\EmployeeGroupFacade;
...
class EmployeeGroupController extends Controller
{
    ...
    {
        $data = EmployeeGroupFacade::getAll();
    ...
    {
        $data = EmployeeGroupFacade::getById($id);
    ...
    {
        $data = EmployeeGroupFacade::store($request->validated());
    ...
    {
        $data = EmployeeGroupFacade::update($request->validated(), $id);
    ...
    {
        return $this->deletedResponse(EmployeeGroupFacade::delete($id), 'EmployeeGroup');
    }
}
