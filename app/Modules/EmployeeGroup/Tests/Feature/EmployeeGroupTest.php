...
namespace Modules\EmployeeGroup\Tests\Feature;
...
class EmployeeGroupTest extends TestCase
{
    ...
    public function test_can_create_employee_group(): void
    {
    ...
    public function test_can_show_employee_group(): void
    {
    ...
    public function test_can_update_employee_group(): void
    {
        $EmployeeGroup = EmployeeGroup::factory()->create();
    ...
    public function test_can_delete_employee_group(): void
    {
        $EmployeeGroup = EmployeeGroup::factory()->create();
