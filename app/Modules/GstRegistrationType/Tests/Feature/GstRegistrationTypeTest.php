...
class GstRegistrationTypeTest extends TestCase
{
    ...
    public function test_can_create_gst_registration_type(): void
    {
    ...
    public function test_can_show_gst_registration_type(): void
    {
    ...
    public function test_can_update_gst_registration_type(): void
    {
        $GstRegistrationType = GstRegistrationType::factory()->create();
    ...
    public function test_can_delete_gst_registration_type(): void
    {
        $GstRegistrationType = GstRegistrationType::factory()->create();
