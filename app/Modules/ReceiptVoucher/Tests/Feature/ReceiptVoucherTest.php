...
class ReceiptVoucherTest extends TestCase
{
    ...
    public function test_can_show_receipt_voucher(): void
    {
    ...
    public function test_can_update_receipt_voucher(): void
    {
        $ReceiptVoucher = ReceiptVoucher::factory()->create();
    ...
    public function test_can_delete_receipt_voucher(): void
    {
        $ReceiptVoucher = ReceiptVoucher::factory()->create();
