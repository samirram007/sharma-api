...
namespace Modules\StockGroup\Tests\Feature;
...
class StockGroupTest extends TestCase
{
    ...
    public function test_can_create_stock_group(): void
    {
    ...
    public function test_can_show_stock_group(): void
    {
    ...
    public function test_can_update_stock_group(): void
    {
        $StockGroup = StockGroup::factory()->create();
    ...
    public function test_can_delete_stock_group(): void
    {
        $StockGroup = StockGroup::factory()->create();
