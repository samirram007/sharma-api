...
namespace Modules\StockItem\Tests\Feature;
...
class StockItemTest extends TestCase
{
    ...
    public function test_can_show_stock_item(): void
    {
    ...
    public function test_can_update_stock_item(): void
    {
        $StockItem = StockItem::factory()->create();
    ...
    public function test_can_delete_stock_item(): void
    {
        $StockItem = StockItem::factory()->create();
