...
namespace Modules\StockItemBatch\Tests\Feature;
...
class StockItemBatchTest extends TestCase
{
    ...
    public function test_can_create_stock_item_batch(): void
    {
    ...
    public function test_can_show_stock_item_batch(): void
    {
    ...
    public function test_can_update_stock_item_batch(): void
    {
        $StockItemBatch = StockItemBatch::factory()->create();
    ...
    public function test_can_delete_stock_item_batch(): void
    {
        $StockItemBatch = StockItemBatch::factory()->create();
