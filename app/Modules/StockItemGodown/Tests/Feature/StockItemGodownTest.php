...
namespace Modules\StockItemGodown\Tests\Feature;
...
class StockItemGodownTest extends TestCase
{
    ...
    public function test_can_create_stock_item_godown(): void
    {
    ...
    public function test_can_show_stock_item_godown(): void
    {
    ...
    public function test_can_update_stock_item_godown(): void
    {
        $StockItemGodown = StockItemGodown::factory()->create();
    ...
    public function test_can_delete_stock_item_godown(): void
    {
        $StockItemGodown = StockItemGodown::factory()->create();
