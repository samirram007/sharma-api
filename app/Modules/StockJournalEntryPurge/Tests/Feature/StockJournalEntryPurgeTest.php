...
namespace Modules\StockJournalEntryPurge\Tests\Feature;
...
class StockJournalEntryPurgeTest extends TestCase
{
    ...
    public function test_can_create_stock_journal_entry_purge(): void
    {
    ...
    public function test_can_show_stock_journal_entry_purge(): void
    {
    ...
    public function test_can_update_stock_journal_entry_purge(): void
    {
        $StockJournalEntryPurge = StockJournalEntryPurge::factory()->create();
    ...
    public function test_can_delete_stock_journal_entry_purge(): void
    {
        $StockJournalEntryPurge = StockJournalEntryPurge::factory()->create();
