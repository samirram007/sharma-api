...
namespace Modules\UserFiscalYear\Tests\Feature;
...
class UserFiscalYearTest extends TestCase
{
    ...
    public function test_can_create_user_fiscal_year(): void
    {
    ...
    public function test_can_show_user_fiscal_year(): void
    {
    ...
    public function test_can_update_user_fiscal_year(): void
    {
        $UserFiscalYear = UserFiscalYear::factory()->create();
    ...
    public function test_can_delete_user_fiscal_year(): void
    {
        $UserFiscalYear = UserFiscalYear::factory()->create();
